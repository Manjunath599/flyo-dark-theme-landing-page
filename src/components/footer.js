...
export default function Footer() {
  return (
    <footer className="	bg-[#0b1523] p-6 lg:flex lg:justify-evenly lg:relative">
      <img className="my-14 lg:absolute lg:left-10 lg:-top-6" src="/images/logo.svg" />
      <div className="lg:mt-20 lg:w-96" >
        <img className="float-left" src="/images/icon-location.svg" />
      ...
      <div className="lg:mt-10">
        <div className="my-10 ">
          <img className="float-left" src="/images/icon-phone.svg" />
          <p className="ml-10">+1-543-123-4567</p>
        </div>
        <div>
          <img className="float-left" src="/images/icon-email.svg" />
